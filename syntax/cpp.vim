...
" Contributer:  Fabien Cazenave <fabien@cazenave.cc>
...
syn keyword moz_type_ns      nsAString nsCOMPtr nsRefPtr nsWeakPtr nsresult nsTArray 
...
"   | sort -u | grep nsIDOM -v
  ...
  syn keyword moz_component  nsIconDecoder nsIconProtocolHandler nsIConsoleListener nsIConsoleMessage
  ...
  syn keyword moz_component  nsIDBusHandlerApp nsIDebug nsIDebug2 nsIDebugDumpContent nsIdentifierMapEntry
  ...
  syn keyword moz_component  nsIDiskCacheStreamInternal nsIdleService nsIdleServiceAndroid nsIdleServiceDaily
  syn keyword moz_component  nsIdleServiceGTK nsIdleServiceOS2 nsIdleServiceQt nsIdleServiceWin
  syn keyword moz_component  nsIdleServiceX nsIDNService nsIDNSListener nsIDNSRecord nsIDNSRequest
  ...
  syn keyword moz_component  nsImageBoxFrame nsImageBoxListener nsImageFrame nsImageFromClipboard
  syn keyword moz_component  nsImageListener nsImageLoader nsImageLoadingContent nsImageMap
  syn keyword moz_component  nsImageToClipboard nsImageToPixbuf nsIMarkupDocumentViewer nsIMathMLFrame
  ...
  syn keyword moz_component  nsIndexedToHTML nsINestedURI nsINetUtil nsINetworkLinkService nsINIParser
  syn keyword moz_component  nsINIParserFactory nsInlineFrame nsINode nsINodeInfo nsINodeList
  syn keyword moz_component  nsINotificationsList nsINPAPIPluginStreamInfo nsInProcessTabChildGlobal
  syn keyword moz_component  nsInputEvent nsInputStreamChannel nsInputStreamPump nsInsertTagCommand
  syn keyword moz_component  nsINSSCertCache nsINSSComponent nsINSSErrorsService nsInstall nsInstallTrigger
  syn keyword moz_component  nsInstantiationNode nsInt2StrHashtable nsInterfaceHashtable
  syn keyword moz_component  nsInterfaceHashtableMT nsInternetCiter nsIntervalSet nsIntRect nsIntRegion
  syn keyword moz_component  nsInvalidateEvent nsInvalidateRequestList nsInvalidPluginTag nsIObjectFrame
...
syn keyword moz_util         NS_EDITOR_ELEMENT_NOT_FOUND
